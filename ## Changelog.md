## v0.31.1(next)
+ Removed the hoe modification code and moved it to another unreleased mod because it's still not working as intended and there were bugs with breaking grass and dirt blocks normally.
